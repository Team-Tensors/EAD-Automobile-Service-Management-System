...
class AuthControllerTest {
    ...
    void testLogout_NoToken() throws Exception {
        ...
        mockMvc.perform(post("/auth/logout")
                        ...
                        .content("{}"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.message").value("Logged out successfully (client-side only)"));

        verify(authService, never()).logout(anyString());
    }

    @Test
    @DisplayName("Should successfully get user profile with authentication")
    @WithMockUser(username = "test@example.com", roles = {"CUSTOMER"})
    void testGetUserProfile_Success() throws Exception {
        // Arrange
        when(authService.findUserByEmail(anyString())).thenReturn(Optional.of(testUser));
        ...
        verify(authService, times(1)).findUserByEmail(anyString());
    }
    ...
    void testUpdateProfile_Success() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(put("/auth/update-profile")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        verify(authService, times(1)).updateProfile(anyString(), anyString(), anyString(), anyString(), anyString());
    }
    ...
    @Test
    @DisplayName("Should register customer with forced customer role")
    ...
    void testRegisterEmployee_Success() throws Exception {
        ...
        signupRequest.setPhoneNumber("2222222222");
