...
const Footer = () => {
  ...
  const officeLocations = [
    { label: "Visit Us:", address: "1234 Main St, Los Angeles, USA" },
    { label: "Our Office:", address: "7 Elm St, San Bernardino, USA" },
    { label: "Headquarters:", address: "1 Tree Ave, New Jersey, USA" },
  ]
    ...
    <footer className="bg-[#1d1c1c] text-white py-16 px-6 md:px-12">
      ...
      <div className="max-w-7xl mx-auto">
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      key={index}
                      href="#"
                      className="w-16 h-16 bg-orange-500 hover:bg-orange-600 transition-colors flex items-center justify-center rounded"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Newsletter Section */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-white uppercase tracking-wide font-heading">Stay Updated with Carsy!</h3>
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="bg-orange-500 hover:bg-orange-600 transition-colors px-6 py-3 flex items-center justify-center">
