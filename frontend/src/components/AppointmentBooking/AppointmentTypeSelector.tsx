...
interface AppointmentTypeSelectorProps {
  selectedType: string;
  onSelectType: (type: 'SERVICE' | 'MODIFICATION') => void;
}

const AppointmentTypeSelector: React.FC<AppointmentTypeSelectorProps> = ({ selectedType, onSelectType }) => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-gray-400 text-sm">Regular maintenance and repairs</p>
        </div>
        <div
          onClick={() => onSelectType('MODIFICATION')}
          className={`cursor-pointer p-6 rounded-lg border-2 transition-all duration-300 ${
        ...
        >
          ...
          <h3 className="text-white font-semibold text-lg mb-2">Modification</h3>
