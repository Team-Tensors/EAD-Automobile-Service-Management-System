            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-gray-400">
                  Join our team as a service technician
                </p>
              </div>
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={handleChange}
                    className={`border-zinc-800 bg-zinc-900 text-white placeholder:text-gray-500 focus-visible:ring-orange-600 focus-visible:ring-offset-zinc-950 pr-10 ${
                      formErrors.password
                        ? "border-red-400 focus:border-red-500"
                        : ""
                    }`}
