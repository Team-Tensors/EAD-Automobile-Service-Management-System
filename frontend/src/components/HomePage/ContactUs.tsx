  ...
  return (
    <section className="py-16 bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-0">
        <div className="mb-10">
          <p className="text-4xl font-bold mb-6 font-heading text-orange-700">Contact Us</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Contact Form column */}
          <div>
            <div className="bg-[#0f0f0f] border border-zinc-800 rounded-md p-6">
              <h3 className="text-2xl font-semibold mb-4 font-heading">Contact Us</h3>
              <p className="text-sm text-gray-400 mb-6">Fill the form below and tell us how we can help. We typically respond within 24 hours.</p>
