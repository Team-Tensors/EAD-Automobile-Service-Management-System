                  ...
                  <div className="absolute right-0 mt-3 w-56 bg-zinc-900 border border-zinc-800 rounded-lg shadow-xl py-2 z-50">
                    ...
                    <div className="border-t border-zinc-800 mt-2 pt-2">
                      <button
                        ...
                        className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-red-400 hover:bg-zinc-800 hover:text-red-300 transition-colors"
                      >
              ...
              {user ? (
                ...
                <div className="border-t border-zinc-800 mt-2">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-400 hover:text-white hover:bg-zinc-800 transition-colors"
                  >
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center gap-3 w-full px-4 py-3 text-sm font-medium text-red-400 hover:text-red-300 hover:bg-zinc-800 transition-colors"
                  >
