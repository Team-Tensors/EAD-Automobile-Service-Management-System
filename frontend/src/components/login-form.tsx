          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">Login to your DriveCare  account</p>
              </div>
              {error && (
              ...
              <div className="flex items-center justify-between mb-4">
                <label className="flex items-center text-sm font-medium cursor-pointer">
                  <input
                    ...
                    onChange={handleChange}
                    className="mr-2 h-4 w-4 text-primary focus:ring-primary focus:ring-2 border-input rounded"
                  />
                  Remember me
                </label>
              </div>
              ...
              <div className="text-center text-sm">
                ...
                <Link to="/register" className="underline underline-offset-4 text-primary hover:text-primary/80">
                  Sign up
                </Link>
              </div>
            </div>
