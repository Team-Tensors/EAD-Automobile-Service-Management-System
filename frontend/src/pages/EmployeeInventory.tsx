                  ...
                  filteredItems.map(item => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-center">
                        <span className={`font-semibold ${item.quantity === 0 ? 'text-red-500' : item.lowStock ? 'text-orange-500' : 'text-card-foreground'}`}>
                          {item.quantity}
          ...
          <div className="bg-card rounded-lg shadow-2xl max-w-md w-full border border-border">
            ...
            <form onSubmit={handleBuyItem} className="p-6 space-y-4">
              <div className="bg-secondary p-4 rounded-lg border border-border">
                ...
                <p className="text-sm text-muted-foreground mt-2 mb-1">Available Stock</p>
                <p className="text-2xl font-bold text-card-foreground">{selectedItem.quantity} units</p>
                <p className="text-sm text-muted-foreground mt-2 mb-1">Unit Price</p>
                <p className="text-lg font-semibold text-card-foreground">{formatCurrency(selectedItem.unitPrice)}</p>
              </div>
              ...
              {buyQuantity > 0 && buyQuantity <= selectedItem.quantity && (
                <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                  <p className="text-sm text-blue-600 dark:text-blue-400 mb-1">Total Cost</p>
