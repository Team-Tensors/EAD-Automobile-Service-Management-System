        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-card-foreground mb-4">
              ...
              {userLocation && <span className="text-sm font-normal text-muted-foreground ml-2">(Sorted by distance)</span>}
            </h2>
                    ...
                    <div className="flex-1">
                      ...
                      {userLocation && (
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-sm font-semibold text-card-foreground">
                            {calculateDistance(userLocation.latitude, userLocation.longitude, center.latitude, center.longitude)} km away
                          </span>
                        </div>
                      )}
                      ...
                      <div className="mt-3">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-semibold text-card-foreground">Available Services:</span>
                        </div>
                ...
                <Marker position={[userLocation.latitude, userLocation.longitude]}>
                  <Popup>
                    <div className="text-center">
                      ...
                      <br />
                      <span className="text-sm">Accuracy: {userLocation.accuracy.toFixed(0)} meters</span>
                    </div>
                  </Popup>
                </Marker>
              )}
        ...
        {selectedCenter && (
          <div className="mt-8 bg-card rounded-lg shadow-md p-6 border border-border">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {/* Available Services */}
              <div>
                <h3 className="font-semibold text-lg text-card-foreground mb-4">Available Services</h3>
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {selectedCenter.services.map((service) => (
                    <div key={service.id} className="bg-secondary rounded-lg p-3 border border-border">
